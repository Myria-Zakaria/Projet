...
<fieldset>
    <p>E-mail (Pseudo) :
    <input type="Email" name="pseudo" class="form-control" id="email"  required="required">

    </p>
    <p>Mot de Passe: 
    <input type="password" name="mdp"  class="form-control" id="password" required="required"/>
